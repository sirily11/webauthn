...
const authenticatorMetadata_js_1 = __importDefault(require("./authenticatorMetadata.js")); //assert {type: 'json'}
...
function resolveAuthenticatorName(aaguid) {
    const aaguidMetadata = updatedAuthenticatorMetadata ?? authenticatorMetadata_js_1.default; //await getAaguidMetadata()
